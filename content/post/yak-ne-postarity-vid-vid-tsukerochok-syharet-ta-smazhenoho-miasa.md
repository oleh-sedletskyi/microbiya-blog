---
introtext: Ми не обіцяємо чарівний еліксир від старості, але на пальцях розкриємо один із ключових механізмів старіння, на який ми маємо вплив, та, традиційно – кілька прийомів, як цей механізм сповільнити. Отож поїхали.
created: '2019-01-03'
